...
// //       _showLoading();
// //
// //       // Get video duration using file metadata
// //       final startTime =
// //           clips.isEmpty
// //               ? Duration.zero
// //               : clips
...
// //                   .reduce((a, b) => a > b ? a : b);
// //
// //       // For now, use default duration (you can add video_player to get actual duration)
...
// //                 onTapDown:
// //                     (details) => handleTimelineClick(details.localPosition.dx),
// //                 child: SingleChildScrollView(
...
// //               borderRadius: BorderRadius.circular(6),
// //             ),
// //             child: const Icon(Icons.volume_off, size: 18),
// //           ),
...
// //     final clipWidth = (clip.duration.inMilliseconds / 1000 * pixelsPerSecond)
...
// //           child:
// //               clip.thumbnailPaths.isNotEmpty
// //                   ? Row(
// //                     children:
// //                         clip.thumbnailPaths
// //                             .map(
...
// //                 children: const [
// //                   SizedBox(width: 10),
// //                   Icon(Icons.audiotrack, size: 18, color: Color(0xFF999999)),
// //                   SizedBox(width: 8),
// //                   Flexible(
// //                     child: Text(
// //                       '+ Add audio',
...
// //                 children: const [
// //                   SizedBox(width: 10),
// //                   Icon(Icons.text_fields, size: 18, color: Color(0xFF999999)),
// //                   SizedBox(width: 8),
// //                   Flexible(
// //                     child: Text(
// //                       '+ Add text',
...
//       final sourceTime = activeVideo.trimStart + Duration(milliseconds: (localTime.inMilliseconds * activeVideo.speed).round());
//
...
//                 children: [
//                   for (int i = 0; i <= totalDuration.toInt(); i += 2) ...[
//                     Text(formatTime(i.toDouble()), style: const TextStyle(fontSize: 10, color: Color(0xFF666666))),
//                     if (i < totalDuration.toInt() - 1)
//                       const Padding(
//                         padding: EdgeInsets.symmetric(horizontal: 24),
//                         child: Text('•', style: TextStyle(color: Color(0xFF444444), fontSize: 10)),
//                       ),
//                   ],
//                 ],
//               ),
...
//           ),
//           const SizedBox(height: 2),
//           const Text('Mute\nclip', textAlign: TextAlign.center, style: TextStyle(fontSize: 9, color: Color(0xFF999999)), maxLines: 2, overflow: TextOverflow.ellipsis),
//         ],
//       ),
//     );
//   }
...
//           ),
//           const SizedBox(height: 2),
//           const Text('Cover', style: TextStyle(fontSize: 9, color: Color(0xFF999999))),
//         ],
//       ),
//     );
//   }
...
//   Widget _buildVideoClip(TimelineItem clip) {
//     final isSelected = selectedClip == int.tryParse(clip.id);
//     final clipWidth = (clip.duration.inMilliseconds / 1000 * pixelsPerSecond).clamp(40.0, double.infinity);
//     return GestureDetector(
//       onTap: () {
//         setState(() {
//           selectedClip = int.tryParse(clip.id);
...
//                   Icon(Icons.audiotrack, size: 18, color: Color(0xFF999999)),
//                   SizedBox(width: 8),
//                   Flexible(child: Text('+ Add audio', style: TextStyle(fontSize: 12, color: Color(0xFF999999)), overflow: TextOverflow.ellipsis)),
//                 ],
//               ),
//             ),
//           ),
...
//                   Icon(Icons.text_fields, size: 18, color: Color(0xFF999999)),
//                   SizedBox(width: 8),
//                   Flexible(child: Text('+ Add text', style: TextStyle(fontSize: 12, color: Color(0xFF999999)), overflow: TextOverflow.ellipsis)),
//                 ],
//               ),
//             ),
//           ),
...
import 'nes_scr/screen/video_editor_screen.dart';
